...
<body>
	<form action="<%=request.getContextPath()%>/new/login.action" method="post">
		<div id="login">
			...
			<div id="content">
				用户名：<input type="text" class="input" name="username" id="userName"
					autofocus onblur="checkUserName()"><br />
				密码：&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" class="input"
					name="password" id="password" onblur="checkPassword()"
					onmouseleave="checkSubmit()" />
				<div>         
					<span id="note">用户名：admin 密码：123</span><br />
				</div>
				<ul>
					<li><input type="submit" id="submit" value="提交"
						disabled="true" /></li>
